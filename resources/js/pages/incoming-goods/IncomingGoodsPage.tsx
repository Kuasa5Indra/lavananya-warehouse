...
import { create, edit, destroy } from "@/routes/reports/incoming-goods";
import type { IncomingGoodsReport } from "@/types";

interface IncomingGoodsPageProps {
    reports: IncomingGoodsReport[]
}

const IncomingGoodsPage: React.FC<IncomingGoodsPageProps> = ({ reports }) => {
    ...
    return (
        <PageContent>
            ...
            <Breadcrumb className="text-sm pl-4">
                ...
                <Breadcrumb.Item label="Incoming Goods" />
            </Breadcrumb>
